...
namespace JerryMouse.UI
{
    ...
    public class MyInfiniteScroll : MonoBehaviour
    {
        ...
        public virtual void SetNewItems(ref List<Transform> newItems)
        {
            if (_scrollRect != null)
            {
                ...
                Victor_SetItems_Hugo();
            }
        }

        private void Victor_SetItems_Hugo()
        {
        ...
        void Gustave_DisableGridComponents_Flaubert()
        {
        ...
        public void OnScroll(Vector2 pos)
        {
            if (!_hasDisabledGridComponents)
                Gustave_DisableGridComponents_Flaubert();
