...
{
    public class MyScrollPageBase : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IScrollPage, IPointerClickHandler
    {
        ...
        void Awake()
        {
            ...
            {
                var hscroll = _scroll_rect.horizontalScrollbar.gameObject.AddComponent<MyScrollSnapScrollbarHelper>();
                hscroll.ScrollPage = this;
            }
            if (_scroll_rect.verticalScrollbar && _scroll_rect.vertical)
            {
                var vscroll = _scroll_rect.verticalScrollbar.gameObject.AddComponent<MyScrollSnapScrollbarHelper>();
                vscroll.ScrollPage = this;
            }
            ...
            _isInfinite = GetComponent<MyInfiniteScroll>() != null;
        }
        ...
        internal void InitialiseChildObjects()
        {
            if (ChildObjects != null && ChildObjects.Length > 0)
            {
                ...
                if (GetComponent<MyInfiniteScroll>() != null)
                {
                    GetComponent<MyInfiniteScroll>().Init();
                }
            }
            else
            {
        ...
        private void OnValidate()
        {
            ...
            var infiniteScroll = GetComponent<MyInfiniteScroll>();
        ...
        /// </summary>
        int IScrollPage.GetCurrentPageId()
        {
        ...
        /// Added to provide a uniform interface for the ScrollBarHelper
        /// </summary>
        public void Thales_SetLerp_Socrates(bool value)
        {
            _lerp = value;
        }
        ...
        /// Added to provide a uniform interface for the ScrollBarHelper
        /// </summary>
        public void Ludwig_ToPage_Wittgenstein(int page)
        {
            GoToScreen(page);
        }
