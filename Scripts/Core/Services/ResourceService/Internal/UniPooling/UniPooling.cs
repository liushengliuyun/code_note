...
namespace Core.Services.ResourceService.Internal.UniPooling
{
    ...
    public static class
        UniPooling
    {
        public static Action<GameObject> OnRestore;
        ...
        public static void Initalize()
        {
            ...
            if (_isInitialize == false)
            {
                ...
                Debug.Log($"{nameof(UniPooling)} initalize !");
            }
        }
        ...
        public static void Destroy()
        {
            if (_isInitialize)
            {
                foreach (var spawner in _spawners.ToArray())
                {
                    spawner.Destroy();
                }
                ...
                Debug.Log($"{nameof(UniPooling)} destroy all !");
            }
        }
        ...
        public static Spawner GetSpawner(string packageName)
        {
            ...
            Debug.LogWarning($"Not found spawner : {packageName}");
            return null;
        }
