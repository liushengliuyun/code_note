    ...
    public sealed class SpawnHandle : GameAsyncOperation
    {
        ...
        public GameObject GameObj
        {
            get
            {
                if (_operation == null)
                {
                    Debug.LogWarning("The spawn handle is invalid !");
                    return null;
                }

                _operation.Result.TryAddSpawnHandle(this);
        ...
        internal SpawnHandle(GameObjectPool pool, InstantiateOperation operation, Transform parent, Vector3 position,
            Quaternion rotation, params System.Object[] userDatas)
        {
            _pool = pool;
