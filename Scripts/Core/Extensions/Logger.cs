...
namespace Core.Extensions
{
    ...
    public class YZLog
    {
        ...
        static YZLog()
        {
            ...
            {
                YZLog.LogConsole_MultiThread("Log Static Constructor Failed!");
                YZLog.LogConsole_MultiThread(e.Message + " , " + e.StackTrace);
            }
#endif
            InitLog2File();
#if UNITY_EDITOR
        ...
        public static double GetMonoUseMemory()
        {
            ...
            var memory = ismain
                ? UnityEngine.Profiling.Profiler.GetMonoUsedSizeLong() * 0.0009765625 * 0.0009765625
                : 0;
            return memory;
        }
        ...
        public static string GetLogPath()
        {
            ...
            var logName = string.Format("game_{0}_{1}_{2}_{3}_{4}_{5}.log", now.Year, now.Month, now.Day, now.Hour,
        ...
        static void InitLogUtility()
        {
            ...
            _activeTextInfo =
                _consoleWindowType.GetField("m_ActiveText", BindingFlags.Instance | BindingFlags.NonPublic);
            _consoleWindowInfo =
                _consoleWindowType.GetField("ms_ConsoleWindow", BindingFlags.Static | BindingFlags.NonPublic);
            _setActiveEntry =
                _consoleWindowType.GetMethod("SetActiveEntry", BindingFlags.Instance | BindingFlags.NonPublic);
        ...
        //
        //                 string fullPath = Application.dataPath.Replace("Assets", "") + "./Product/Lua/" + luaFile +
        //                                   ".lua";
        ...
        //                 int index = 0;
        //                 var dstStack = (stackTrace.StartsWith("[Error]") || stackTrace.StartsWith("[Exception]"))
        //                     ? 4
        //                     : 3;
            ...
            if (instanceID == s_InstanceID && ArrayContains(s_Lines, line))
            {
                ...
                if (stackFrame != null)
                {
                    if (_luaLog != null)
                    {
                        ...
                        string fullPath =
 Application.dataPath.Replace("Assets", "") + "./Product/Lua/" + luaFile + ".lua";
