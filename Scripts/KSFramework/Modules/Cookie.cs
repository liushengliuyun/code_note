...
namespace KSFramework
{
    ...
    public class Cookie
    {
        ...
        protected static Dictionary<string, List<CookieSetListener>> _setListeners =
            new Dictionary<string, List<CookieSetListener>>();
        ...
        public static object Get(string key)
        {
            ...
            {
                YZLog.Warning("not find key {0} in Cookie", key);
                return null;
            }
        }
