...
using KEngine;
using KEngine.UI;
using KSFramework.KEngine.KEngine.UI;
...
", KSFrameworkInfo.Version);
        ...
        public static void OpenLastScene()
        {
            ...
            YZLog.Info("Open Last Game Scene!");
            ...
            {
                YZLog.LogWarning("Not found last scene!");
            }
        }
        ...
        public static void OpenMainScene()
        {
            ...
            YZLog.Info("Open Main Game Scene!");
#if UNITY_5 || UNITY_2017_1_OR_NEWER
        ...
        public static void AutoMakeUILuaScripts()
        {
            ...
            if (windowAssets.Length > 0)
            {
                foreach (var windowAsset in windowAssets)
                {
                    ...
                    var scriptPath =
 $"{KResourceModule.EditorProductFullPath}/{AppConfig.LuaPath}/UI/{uiName}/{uiName}.lua";
...
";
        ...
        public static void ReloadAllUIAB()
        {
            if (!EditorApplication.isPlaying)
            {
                YZLog.LogError("Reload UI only when your editor is playing!");
                return;
            }
        ...
        public static void ReloadUIAB(string uiName)
        {
            ...
            {
                YZLog.Info("UI:{0} 未打开过，无需处理", uiName);
            }
        }
