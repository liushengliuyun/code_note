...
{
    /// <summary>
    /// Auto Generate for Tab File: "TSV#.tsv"
    /// Excel File: TSV#.tsv
    /// No use of generic and reflection, for better performance,  less IL code generating
    /// </summary>>
    public partial class TSVSettings : IReloadableSettings
    {
        /// <summary>
        ...
        public static TSVSettings _instance = new TSVSettings();
        Dictionary<string, TSVSetting> _dict = new Dictionary<string, TSVSetting>();
        ...
        /// </summary>
        /// <returns></returns>
        public static TSVSettings GetInstance()
        {
            if (ReloadCount == 0)
            {
        ...
        /// <summary>
        /// Do reload the setting file: TSV, no exception when duplicate primary key
        /// </summary>
        ...
        /// <summary>
        /// Do reload the setting class : TSV, no exception when duplicate primary key, use custom string content
        /// </summary>
        ...
        /// <summary>
        /// Do reload the setting file: TSV
        /// </summary>
        void _ReloadAll(bool throwWhenDuplicatePrimaryKey, string customContent = null)
        {
            for (var j = 0; j < TabFilePaths.Length; j++)
            {
                ...
                using (tableFile)
                {
                    ...
                    {
                        var pk = TSVSetting.ParsePrimaryKey(row);
                        TSVSetting setting;
                        if (!_dict.TryGetValue(pk, out setting))
                        {
                            setting = new TSVSetting(row);
        ...
        /// <summary>
        /// GetEnumerator for `MoveNext`: TSV
        /// </summary> 
        ...
        /// <summary>
        /// Get class by primary key: TSV
        /// </summary>
        public static TSVSetting Get(string primaryKey)
        {
            TSVSetting setting;
    ...
    /// </summary>
    public partial class TSVSetting : TableRowFieldParser
    {
        /// <summary>
        /// ID Column/编号/主键
        /// </summary>
        ...
        internal TSVSetting(TableFileRow row)
        {
            Reload(row);
        }
