...
{
    /// <summary>
    /// Auto Generate for Tab File: "en_US.tsv"
    /// Excel File: en_US.xlsx
    /// No use of generic and reflection, for better performance,  less IL code generating
    /// </summary>>
    public partial class EnUSSettings : IReloadableSettings
    {
        /// <summary>
        ...
        public static EnUSSettings _instance = new EnUSSettings();
        Dictionary<string, EnUSSetting> _dict = new Dictionary<string, EnUSSetting>();
        ...
        /// </summary>
        /// <returns></returns>
        public static EnUSSettings GetInstance()
        {
            if (ReloadCount == 0)
            {
        ...
        /// <summary>
        /// Do reload the setting file: EnUS, no exception when duplicate primary key
        /// </summary>
        ...
        /// <summary>
        /// Do reload the setting class : EnUS, no exception when duplicate primary key, use custom string content
        /// </summary>
        ...
        /// <summary>
        /// Do reload the setting file: EnUS
        /// </summary>
        void _ReloadAll(bool throwWhenDuplicatePrimaryKey, string customContent = null)
        {
            for (var j = 0; j < TabFilePaths.Length; j++)
            {
                ...
                using (tableFile)
                {
                    ...
                    {
                        var pk = EnUSSetting.ParsePrimaryKey(row);
                        EnUSSetting setting;
                        if (!_dict.TryGetValue(pk, out setting))
                        {
                            setting = new EnUSSetting(row);
        ...
        /// <summary>
        /// GetEnumerator for `MoveNext`: EnUS
        /// </summary> 
        ...
        /// <summary>
        /// Get class by primary key: EnUS
        /// </summary>
        public static EnUSSetting Get(string primaryKey)
        {
            EnUSSetting setting;
    ...
    /// </summary>
    public partial class EnUSSetting : TableRowFieldParser
    {
        /// <summary>
        /// 原文
        /// </summary>
