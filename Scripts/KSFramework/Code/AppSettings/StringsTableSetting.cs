...
{
    /// <summary>
    /// Auto Generate for Tab File: "StringsTable.tsv"
    /// Excel File: StringsTable.xlsx
    /// No use of generic and reflection, for better performance,  less IL code generating
    /// </summary>>
    public partial class StringsTableSettings : IReloadableSettings
    {
        /// <summary>
        ...
        public static StringsTableSettings _instance = new StringsTableSettings();
        Dictionary<string, StringsTableSetting> _dict = new Dictionary<string, StringsTableSetting>();
        ...
        /// </summary>
        /// <returns></returns>
        public static StringsTableSettings GetInstance()
        {
            if (ReloadCount == 0)
            {
        ...
        /// <summary>
        /// Do reload the setting file: StringsTable, no exception when duplicate primary key
        /// </summary>
        ...
        /// <summary>
        /// Do reload the setting class : StringsTable, no exception when duplicate primary key, use custom string content
        /// </summary>
        ...
        /// <summary>
        /// Do reload the setting file: StringsTable
        /// </summary>
        void _ReloadAll(bool throwWhenDuplicatePrimaryKey, string customContent = null)
        {
            for (var j = 0; j < TabFilePaths.Length; j++)
            {
                ...
                using (tableFile)
                {
                    ...
                    {
                        var pk = StringsTableSetting.ParsePrimaryKey(row);
                        StringsTableSetting setting;
                        if (!_dict.TryGetValue(pk, out setting))
                        {
                            setting = new StringsTableSetting(row);
        ...
        /// <summary>
        /// foreachable enumerable: StringsTable
        /// </summary>
        ...
        /// <summary>
        /// GetEnumerator for `MoveNext`: StringsTable
        /// </summary> 
        ...
        /// <summary>
        /// Get class by primary key: StringsTable
        /// </summary>
        public static StringsTableSetting Get(string primaryKey)
        {
            StringsTableSetting setting;
    ...
    /// </summary>
    public partial class StringsTableSetting : TableRowFieldParser
    {
        /// <summary>
        /// ID Column/编号/主键
        /// </summary>
