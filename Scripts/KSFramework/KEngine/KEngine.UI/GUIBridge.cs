...
//                     Log.Info("{0} Load AB, cost:{1:0.000}s", loadState.TemplateName,
//                         Time.realtimeSinceStartup - beginTime);
//                 if (AppConfig.IsSaveCostToFile)
//                     LogFileManager.WriteUILog(loadState.TemplateName, LogState.LoadAB,
//                         Time.realtimeSinceStartup - beginTime);
