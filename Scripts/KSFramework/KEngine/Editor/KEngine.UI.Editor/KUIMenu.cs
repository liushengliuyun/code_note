...
namespace KEngine.Editor
{
    ...
    public class KUIMenu
    {
                ...
                if (_buttonSprite == null)
                    _buttonSprite =
                        AssetDatabase.LoadAssetAtPath<Sprite>(
                            $"Assets/{KEngineDef.ResourcesEditDir}/UI/atlas_common/btn_panel_02.png");
        ...
        private static Sprite closeSprite
        {
            get
            {
                if (_closeSprite == null)
                    _closeSprite =
                        AssetDatabase.LoadAssetAtPath<Sprite>(
                            $"Assets/{KEngineDef.ResourcesEditDir}/UI/atlas_common/btn_win_close.png");
                return _closeSprite;
            }
        }
        ...
        static MyText SetDefaultTextValues(GameObject go, string langId = null)
        {
            ...
            {
                text.LangId = langId;
                text.text = langId ?? I18N.Get(langId);
                text.UseLangId = false;
            }

            text.raycastTarget = false;
            text.horizontalOverflow = HorizontalWrapMode.Wrap;
            text.verticalOverflow = VerticalWrapMode.Truncate;
            text.font = Resources.Load<Font>("Fonts/POETSENBETA08-REGULAR");
        ...
        {
            AddButton(menuCommand, buttonSprite);
        }
        ...
        static public Button AddButton(MenuCommand menuCommand, Sprite sprite, string langId = "")
        {
            ...
            image.SetNativeSize();
            MyButton button = buttonRoot.AddComponent<MyButton>();
