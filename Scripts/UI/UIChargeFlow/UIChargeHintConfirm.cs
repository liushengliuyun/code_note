...
{
    public class UIChargeHintConfirmData
    {
        public enum UIChargeHintConfirmType
        {
            TwoBtn,
            OneBtn
        }

        public UIChargeHintConfirmType Type;
    ...
    public class UIChargeHintConfirm : UIBase<UIChargeHintConfirm>
    {
        ...
        {
            var data = GetArgsByIndex<UIChargeHintConfirmData>(0);
        ...
        void LoadStyle(UIChargeHintConfirmData.UIChargeHintConfirmType UIChargeHintConfirmType)
        {
            switch (UIChargeHintConfirmType)
            {
                case UIChargeHintConfirmData.UIChargeHintConfirmType.TwoBtn:
                    TwoBtnGroup.SetActive(true);
                    OneBtnGroup.SetActive(false);

                    break;
                case UIChargeHintConfirmData.UIChargeHintConfirmType.OneBtn:
        ...
        private void SetTryAgainTween(UIChargeHintConfirmData data)
        {
        ...
        private void TryTryAgain(UIChargeHintConfirmData data)
        {
            tryAgainCount++;
            CancelBtnMask.fillAmount = 1;
            //自动重连
            if (tryAgainCount < 3)
            {
            ...
            else
            {
                data.SendTryAgain?.Invoke();
                //只显示relogin
                LoadStyle(UIChargeHintConfirmData.UIChargeHintConfirmType.OneBtn);
