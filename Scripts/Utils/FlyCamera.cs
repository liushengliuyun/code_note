...
namespace Utils
{
    public class FlyCamera : MonoBehaviour
    {
        ...
        */
        ...
        [Tooltip("The terrain to follow")] public Terrain anchorToTerrain;
        ...
        [Tooltip("Regular speed")] public float mainSpeed = 2f;
        [Tooltip("Rotation speed")] public float rotationSpeed = 20f;
        ...
        private void Update()
        {
            ...
            if (anchorToTerrain)
            {
                ...
                newPosition.x = Mathf.Clamp(newPosition.x, anchorToTerrain.transform.position.x,
                    anchorToTerrain.transform.position.x + anchorToTerrain.terrainData.size.x);
                newPosition.z = Mathf.Clamp(newPosition.z, anchorToTerrain.transform.position.z,
                    anchorToTerrain.transform.position.z + anchorToTerrain.terrainData.size.z);
