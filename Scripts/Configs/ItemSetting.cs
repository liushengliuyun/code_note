...
{
    /// <summary>
    /// Auto Generate for Tab File: "Item.tsv"
    /// Excel File: Item.xlsx
    /// No use of generic and reflection, for better performance,  less IL code generating
    /// </summary>>
    public partial class ItemSettings : IReloadableSettings
    {
        /// <summary>
        ...
        public static ItemSettings _instance = new ItemSettings();
        Dictionary<int, ItemSetting> _dict = new Dictionary<int, ItemSetting>();
        ...
        /// </summary>
        /// <returns></returns>
        public static ItemSettings GetInstance()
        {
            if (ReloadCount == 0)
            {
        ...
        /// <summary>
        /// Do reload the setting file: Item, no exception when duplicate primary key
        /// </summary>
        ...
        /// <summary>
        /// Do reload the setting class : Item, no exception when duplicate primary key, use custom string content
        /// </summary>
        ...
        /// <summary>
        /// Do reload the setting file: Item
        /// </summary>
        void _ReloadAll(bool throwWhenDuplicatePrimaryKey, string customContent = null)
        {
            for (var j = 0; j < TabFilePaths.Length; j++)
            {
                ...
                using (tableFile)
                {
                    ...
                    {
                        var pk = ItemSetting.ParsePrimaryKey(row);
                        ItemSetting setting;
                        if (!_dict.TryGetValue(pk, out setting))
                        {
                            setting = new ItemSetting(row);
        ...
        /// <summary>
        /// GetEnumerator for `MoveNext`: Item
        /// </summary> 
        ...
        /// <summary>
        /// Get class by primary key: Item
        /// </summary>
        public static ItemSetting Get(int primaryKey)
        {
            ItemSetting setting;
    ...
    /// </summary>
    public partial class ItemSetting : TableRowFieldParser
    {
        /// <summary>
        /// ID Column/编号/主键
        /// </summary>
        ...
        internal ItemSetting(TableFileRow row)
        {
            Reload(row);
        }
        ...
        internal void Reload(TableFileRow row)
        {
            ...
            Icon = row.Get_string(row.Values[2], "");
        }
